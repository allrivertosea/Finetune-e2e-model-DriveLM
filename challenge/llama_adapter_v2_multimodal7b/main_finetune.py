...
def get_args_parser():
    ...
    parser.add_argument('--llama_path', default='/APP/DriveLM/challenge/model_weights/llama_model_weights', type=str,
                        help='path to LLaMA pretrained checkpoint')
    parser.add_argument('--pretrained_path', default='/APP/DriveLM/challenge/model_weights/LLaMA-Adapter_V2/7fa55208379faf2dd862565284101b0e4a2a72114d6490a95e432cf9d9b6c813_BIAS-7B.pth', type=str,
    ...
    parser.add_argument('--blr', type=float, default=10e-4, metavar='LR',
    ...
    # Dataset parameters
    parser.add_argument('--data_config', default='/APP/DriveLM/challenge/llama_adapter_v2_multimodal7b/finetune_data_config.yaml', type=str,
    ...
    parser.add_argument('--output_dir', default='/APP/DriveLM/outputs/nuscenes_v1_debug',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/APP/DriveLM/outputs/nuscenes_v1_debug',
