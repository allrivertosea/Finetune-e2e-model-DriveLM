...
parser.add_argument('--llama_dir', type=str, default="/APP/DriveLM/challenge/model_weights/llama_model_weights", help='path to llama model weights')
parser.add_argument('--checkpoint', type=str, default="/APP/DriveLM/outputs/checkpoint-2.pth", help='path to pre-trained checkpoint')
parser.add_argument('--data', type=str, default="/APP/DriveLM/challenge/test_llama.json", help='path to test data')
parser.add_argument('--output', type=str, default="/APP/DriveLM/challenge/test_output.json", help='path to output file')
