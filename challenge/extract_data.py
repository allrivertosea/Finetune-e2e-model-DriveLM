...
if __name__ == "__main__":
    ...
    root_path = "/APP/DriveLM/challenge/llama_adapter_v2_multimodal7b/data/QA_dataset_nus/v1_1_train_nus.json"
    save_path = "/APP/DriveLM/challenge/covert_data/v1_1_train_nus_extract.json"
    root_path = "/APP/DriveLM/challenge/llama_adapter_v2_multimodal7b/data/QA_dataset_nus/v1_1_train_nus.json"
    save_path = "/APP/DriveLM/challenge/covert_data/v1_1_train_nus_extract.json"
    extract_data(root_path, save_path)
