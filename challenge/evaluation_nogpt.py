...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path1', type=str, default="/APP/DriveLM/challenge/output.json", help='path to prediction file')
    parser.add_argument('--root_path2', type=str, default="/APP/DriveLM/challenge/test_eval.json", help='path to test file')
    ...
    for k, v in output["language"].items():
        print("language score {}: {}".format(k, v))
    
    # Normalize to 0-1 and combine the scores: language, match, accuracy
    scores = []
    weights = [0.2, 0.2, 0.2]
